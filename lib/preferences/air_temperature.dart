const airTemperature = "Air Temperature (C)";
const airTemperatureTag = "air_temperature";
const airTemperatureMin = -25;
const airTemperatureDefault = 15;
const airDensityDefault = 1.226;
const airTemperatureMax = 35;
const airTemperatureDivisions = 12;
