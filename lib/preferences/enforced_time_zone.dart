const enforcedTimeZone = "Enforced Time Zone";
const enforcedTimeZoneTag = "enforced_time_zone";
const enforcedTimeZoneDefault = "Auto Detected";
const enforcedTimeZoneDescription =
    "The supposed time-zone of a workout. "
