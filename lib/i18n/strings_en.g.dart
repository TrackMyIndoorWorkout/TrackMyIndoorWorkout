...
class TranslationsPreferencesEn {
  ...
  late final TranslationsPreferencesNotificationsEn notifications =
      TranslationsPreferencesNotificationsEn.internal(_root);
...
class TranslationsHistoryEn {
  ...
  late final TranslationsHistoryDeleteConfirmationEn deleteConfirmation =
      TranslationsHistoryDeleteConfirmationEn.internal(_root);
}
...
class TranslationsPreferencesThemeEn {
  ...
  late final TranslationsPreferencesThemeOptionsEn options =
      TranslationsPreferencesThemeOptionsEn.internal(_root);
}
...
class TranslationsPreferencesNotificationsEn {
  ...
  late final TranslationsPreferencesNotificationsSoundEn sound =
      TranslationsPreferencesNotificationsSoundEn.internal(_root);
}
...
class TranslationsPreferencesDataEn {
  ...
  late final TranslationsPreferencesDataExportEn export =
      TranslationsPreferencesDataExportEn.internal(_root);
  late final TranslationsPreferencesDataImportDataEn importData =
      TranslationsPreferencesDataImportDataEn.internal(_root);
  late final TranslationsPreferencesDataClearCacheEn clearCache =
      TranslationsPreferencesDataClearCacheEn.internal(_root);
}
...
class TranslationsPreferencesAboutEn {
  ...
  late final TranslationsPreferencesAboutUpdatesEn updates =
      TranslationsPreferencesAboutUpdatesEn.internal(_root);
...
class TranslationsPreferencesUnitsEn {
  ...
  late final TranslationsPreferencesUnitsDistanceEn distance =
      TranslationsPreferencesUnitsDistanceEn.internal(_root);
  late final TranslationsPreferencesUnitsSpeedEn speed =
      TranslationsPreferencesUnitsSpeedEn.internal(_root);
}
...
class TranslationsPreferencesNotificationsSoundEn {
  ...
  late final TranslationsPreferencesNotificationsSoundOptionsEn options =
      TranslationsPreferencesNotificationsSoundOptionsEn.internal(_root);
}
...
class TranslationsPreferencesDataClearCacheEn {
  ...
  late final TranslationsPreferencesDataClearCacheConfirmDialogEn confirmDialog =
      TranslationsPreferencesDataClearCacheConfirmDialogEn.internal(_root);
}
...
class TranslationsPreferencesUnitsDistanceEn {
  ...
  late final TranslationsPreferencesUnitsDistanceOptionsEn options =
      TranslationsPreferencesUnitsDistanceOptionsEn.internal(_root);
}
...
class TranslationsPreferencesUnitsSpeedEn {
  ...
  late final TranslationsPreferencesUnitsSpeedOptionsEn options =
      TranslationsPreferencesUnitsSpeedOptionsEn.internal(_root);
}
...
class TranslationsPreferencesDataClearCacheConfirmDialogEn {
  ...
  String get message =>
      'Are you sure you want to clear the application cache? This cannot be undone.';
}
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'common.appName':
        return 'Track My Indoor Exercise';
      case 'common.ok':
        return 'OK';
      case 'common.cancel':
        return 'Cancel';
      ...
      case 'preferences.title':
        return 'Preferences';
      case 'preferences.theme.title':
        return 'Appearance';
      case 'preferences.theme.description':
        return 'Choose the application theme.';
      case 'preferences.theme.options.light':
        return 'Light';
      case 'preferences.theme.options.dark':
        return 'Dark';
      case 'preferences.theme.options.system':
        return 'System Default';
      case 'preferences.notifications.title':
        return 'Notifications';
      case 'preferences.notifications.enable':
        return 'Enable Notifications';
      case 'preferences.notifications.description':
        return 'Allow the app to send you notifications.';
      case 'preferences.notifications.sound.title':
        return 'Notification Sound';
      case 'preferences.notifications.sound.select':
        return 'Select Notification Sound';
      case 'preferences.notifications.sound.current':
        return 'Current sound: {soundName}';
      case 'preferences.notifications.sound.options.defaultSound':
        return 'Default Sound';
      case 'preferences.notifications.sound.options.silent':
        return 'Silent';
      case 'preferences.data.title':
        return 'Data Management';
      case 'preferences.data.export.title':
        return 'Export Data';
      case 'preferences.data.export.description':
        return 'Export your workout data to a file.';
      case 'preferences.data.export.button':
        return 'Export Data';
      case 'preferences.data.export.inProgress':
        return 'Exporting data...';
      case 'preferences.data.export.success':
        return 'Data exported successfully to {path}';
      case 'preferences.data.export.error':
        return 'Failed to export data.';
      case 'preferences.data.importData.title':
        return 'Import Data';
      case 'preferences.data.importData.description':
        return 'Import workout data from a file.';
      case 'preferences.data.importData.button':
        return 'Import Data';
      case 'preferences.data.importData.selectFile':
        return 'Select file to import';
      case 'preferences.data.importData.inProgress':
        return 'Importing data...';
      case 'preferences.data.importData.success':
        return 'Data imported successfully.';
      case 'preferences.data.importData.error':
        return 'Failed to import data.';
      case 'preferences.data.clearCache.title':
        return 'Clear Cache';
      case 'preferences.data.clearCache.description':
        return 'Clear temporary application data.';
      case 'preferences.data.clearCache.button':
        return 'Clear Cache';
      case 'preferences.data.clearCache.inProgress':
        return 'Clearing cache...';
      case 'preferences.data.clearCache.success':
        return 'Cache cleared successfully.';
      case 'preferences.data.clearCache.error':
        return 'Failed to clear cache.';
      case 'preferences.data.clearCache.confirmDialog.title':
        return 'Confirm Clear Cache';
      case 'preferences.data.clearCache.confirmDialog.message':
        return 'Are you sure you want to clear the application cache? This cannot be undone.';
      case 'preferences.about.title':
        return 'About';
      case 'preferences.about.version':
        return 'Version {version}';
      case 'preferences.about.updates.button':
        return 'Check for Updates';
      case 'preferences.about.updates.checking':
        return 'Checking for updates...';
      case 'preferences.about.updates.upToDate':
        return 'App is up to date.';
      case 'preferences.about.updates.available':
        return 'New version available: {newVersion}';
      case 'preferences.about.rate':
        return 'Rate App';
      case 'preferences.about.privacy':
        return 'Privacy Policy';
      case 'preferences.about.terms':
        return 'Terms of Service';
      case 'preferences.about.licenses':
        return 'Open Source Licenses';
      case 'preferences.units.title':
        return 'Units';
      case 'preferences.units.description':
        return 'Choose measurement units.';
      case 'preferences.units.distance.title':
        return 'Distance Unit';
      case 'preferences.units.distance.options.kilometers':
        return 'Kilometers (km)';
      case 'preferences.units.distance.options.miles':
        return 'Miles (mi)';
      case 'preferences.units.speed.title':
        return 'Speed Unit';
      case 'preferences.units.speed.options.kmh':
        return 'Kilometers per hour (km/h)';
      case 'preferences.units.speed.options.mph':
      ...
      case 'workout.calories':
        return 'Calories';
      case 'workout.noDevice':
        return 'No device connected.';
      case 'workout.searchingDevice':
        return 'Searching for device...';
      case 'history.title':
        return 'Workout History';
      case 'history.empty':
        return 'No workouts recorded yet.';
      case 'history.deleteConfirmation.title':
        return 'Delete Workout?';
      case 'history.deleteConfirmation.message':
        return 'Are you sure you want to delete this workout? This action cannot be undone.';
      case 'sharing.shareWorkout':
        return 'Share Workout';
      case 'sharing.shareSuccess':
        return 'Workout shared successfully.';
      case 'sharing.shareError':
        return 'Failed to share workout.';
      default:
        return null;
    }
  }
