...
const FloorMigrationSchema = CollectionSchema(
  ...
  idName: r'id',
  indexes: {
    r'floorId_entityName': IndexSchema(
      id: -597463895633909675,
      name: r'floorId_entityName',
      unique: false,
      replace: false,
      properties: [
        IndexPropertySchema(
...
extension FloorMigrationQueryWhere on QueryBuilder<FloorMigration, FloorMigration, QWhereClause> {
  ...
  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdEqualToAnyEntityName(
      int floorId) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'floorId_entityName',
        value: [floorId],
      ));
    });
  }

  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdNotEqualToAnyEntityName(
      int floorId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdGreaterThanAnyEntityName(
    int floorId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdLessThanAnyEntityName(
    int floorId, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdBetweenAnyEntityName(
    int lowerFloorId,
    int upperFloorId, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause> floorIdEntityNameEqualTo(
      int floorId, String entityName) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'floorId_entityName',
        value: [floorId, entityName],
      ));
    });
  }

  QueryBuilder<FloorMigration, FloorMigration, QAfterWhereClause>
      floorIdEqualToEntityNameNotEqualTo(int floorId, String entityName) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
              indexName: r'floorId_entityName',
              lower: [floorId],
              upper: [floorId, entityName],
              includeUpper: false,
            ))
            .addWhereClause(IndexWhereClause.between(
              indexName: r'floorId_entityName',
              lower: [floorId, entityName],
              includeLower: false,
              upper: [floorId],
            ));
      } else {
